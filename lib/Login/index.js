...
module.exports = _react2.default.createClass({
  ...
  propTypes: {
    ...
    forgetPassword: _react.PropTypes.string.isRequired,
    signIn: _react.PropTypes.string.isRequired,
    forgetPasswordLink: _react.PropTypes.string.isRequired,
    signInLink: _react.PropTypes.string.isRequired,
    remenber: _react.PropTypes.string.isRequired,
